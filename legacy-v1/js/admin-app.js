...
function fieldControl(name,value){
  ...
  if(/description|_bio|admin_notes/.test(name))return `<label>${label}<textarea name="${name}" rows="4" ${name==='short_description'?'maxlength="160"':''}>${escape(value)}</textarea></label>`;
