...
export function SiteHeader(){
  ...
  return <header className="sticky top-0 z-50 border-b border-stone/15 bg-ivory/90 backdrop-blur-xl"><div className="shell flex h-28 items-center justify-between gap-5">
    <Link href="/" aria-label="Roam Ceylon home" className="relative block h-24 w-[168px] shrink-0 overflow-hidden sm:w-[184px]"><Image src="/assets/logo/roam-ceylon-elephant.png" alt="Roam Ceylon" fill priority sizes="(max-width: 640px) 168px, 184px" className="scale-[1.32] object-contain"/></Link>
