...
export function SiteHeader(){
  ...
  return <header className="sticky top-0 z-50 border-b border-divider bg-ivory/95 backdrop-blur-md">
    <div className="shell flex min-h-20 items-center justify-between gap-4 py-3 sm:min-h-24">
      ...
      <div className="hidden items-center gap-5 xl:flex">
        <Link href="/partners" className="text-link inline-flex min-h-11 items-center text-sm">Partner with us</Link>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent title="Explore The Ceylon Edition" description="Public navigation and journey planning. Close this menu with Escape or the close button.">
          <nav className="grid gap-2" aria-label="Mobile primary">
            ...
            <DialogClose asChild><Link href="/partners" className="text-link flex min-h-12 items-center px-3 text-base">Partner with us</Link></DialogClose>
