...
export const defaultRolePermissions:Record<StaffRole,readonly StaffPermission[]>={
  ...
  journey_designer:["journey.requests.view","journey.design.view","journey.design.edit","journey.proposal.view","journey.proposal.create","suppliers.view","benefits.view","benefits.assign"],
  partner_manager:["journey.requests.view","journey.design.view","suppliers.view","suppliers.manage","suppliers.allocate","suppliers.rates.view","benefits.view","benefits.manage","benefits.assign","benefits.reference.view","benefits.reference.manage"],
  operations:["journey.requests.view","journey.design.view","suppliers.view","operations.view","operations.manage","benefits.view","benefits.assign"],
  finance:["journey.requests.view","journey.design.view","journey.proposal.view","suppliers.view","suppliers.rates.view","benefits.view","benefits.reference.view","finance.revenue.view","finance.costs.view","finance.margin.view","finance.payments.manage"],
...
export const adminNavigationPermissions={
  ...
  guides:"suppliers.view",partners:"suppliers.view",benefits:"benefits.view",pricing:"settings.manage",partnerSettings:"settings.manage"
