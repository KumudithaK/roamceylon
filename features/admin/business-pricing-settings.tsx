...
export function BusinessPricingSettings(){
  ...
  return <main className="min-h-screen bg-[#f4f3ef] p-6 md:p-10"><div className="mx-auto max-w-6xl">
    ...
    <div className="mt-8 flex flex-wrap items-end justify-between gap-5"><div><p className="eyebrow mb-3">Business settings</p><h1 className="font-serif text-4xl md:text-5xl">Pricing</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate/60">Set The Ceylon Edition’s confidential operating costs and selling rules. Hotel, vehicle, guide and experience rates remain inside their own editors.</p></div><Button onClick={()=>void save()} disabled={saving}>{saving?"Saving…":"Save settings"}</Button></div>
