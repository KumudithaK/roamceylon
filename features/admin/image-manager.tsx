...
export function ImageManager({resourceType,resourceId,hero,gallery,onHeroChange,onGalleryChange}:{resourceType:string;resourceId:string;hero:string|null;gallery:string[];onHeroChange:(url:string|null)=>void;onGalleryChange:(urls:string[])=>void}){
