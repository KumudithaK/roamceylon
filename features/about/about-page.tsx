  ...
  return <>
    ...
    <section className="section overflow-hidden">
      <div className="shell grid items-center gap-12 lg:grid-cols-[.88fr_1.12fr] lg:gap-24">
        ...
        <FadeIn delay={.08}><p className="eyebrow mb-5">The Roam Ceylon story</p><h2 className="heading">Nothing this personal should ever feel taken from a shelf.</h2><div className="prose-luxury mt-8 space-y-6"><p>A Roam Ceylon journey begins with a conversation. You bring the places, interests and moments that matter to you; we listen closely and begin with a fresh page.</p><p>Our Journey Designers lay out the route like a working sketch—bringing destinations together, considering the pace between them and choosing experiences that belong naturally within the story.</p><p>Then comes the fitting and refining. We check the timing, stays, local partners and practical details, adjusting each element until the journey feels balanced, personal and ready to carry your name.</p></div></FadeIn>
      </div>
    </section>
