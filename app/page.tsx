...
export default async function Home(){
  ...
  return <main><Hero media={hero} themes={themes} destinations={destinations}/><EditorialHome themes={themes} destinations={destinations} experiences={experiences}/></main>;
}
