...
const profiles={
  Adventure:{lens:"active exploration",included:["Pre-experience safety briefing","Specialist local operator and required activity equipment","Roam Ceylon timing and access coordination"],know:["Operation depends on safe weather and local access conditions.","Final age, fitness and equipment requirements are confirmed by the selected operator."],tips:["Wear secure footwear and quick-drying layers.","Carry only essentials in a protected day bag."],badges:["Adventure"]},
  "Water Sports":{lens:"time on Sri Lanka's water",included:["Safety briefing and activity equipment specified by the operator","Qualified local crew or instructor where the activity requires one","Roam Ceylon timing and access coordination"],know:["Sea, river and wind conditions can change the operating plan.","Swimming ability, age limits and safety equipment must be reconfirmed before travel."],tips:["Use reef-safe sun protection and secure eyewear.","Keep phones and cameras in a dry bag."],badges:["Water Activity","Adventure"]},
  Wildlife:{lens:"responsible wildlife observation",included:["Responsible local operator or naturalist as confirmed","Required park or activity coordination","Roam Ceylon scheduling around the most suitable viewing period"],know:["Wildlife is free-ranging, so sightings and animal behaviour are never guaranteed.","Keep a respectful distance and follow all park or guide instructions."],tips:["Wear muted colours and keep voices low.","Bring binoculars and avoid flash photography around wildlife."],badges:["Wildlife"]},
  History:{lens:"Sri Lanka's layered history",included:["Locally informed interpretation where specified","Roam Ceylon access and timing coordination","Relevant entry arrangements only when listed in the proposal"],know:["Opening hours, worship periods and conservation access can change.","Dress and behaviour must respect active sacred places."],tips:["Choose light, modest clothing and easy-to-remove footwear for sacred sites.","Start early for cooler conditions and quieter interpretation."],badges:["Cultural Heritage"]},
  Culture:{lens:"a living Sri Lankan cultural tradition",included:["Cultural context and etiquette briefing","Locally arranged access where required","Roam Ceylon timing and host coordination"],know:["This is a living community or religious tradition, not a staged attraction.","Ceremony times and local access can change without notice."],tips:["Ask before photographing people, ceremonies or workshops.","Dress modestly and allow the host or guide to lead etiquette."],badges:["Cultural Heritage"]},
  Photography:{lens:"place-led photography",included:["Roam Ceylon timing around the preferred light","Locally arranged access where required","Unhurried photographic stops within the confirmed programme"],know:["Light, visibility and access remain weather-dependent.","Drone use always requires separate landowner and aviation permission."],tips:["Carry a lens cloth and a light rain cover.","Prioritise respectful observation over obstructing paths or ceremonies."],badges:["Photography Spot"]},
  Nature:{lens:"quiet immersion in the landscape",included:["Locally informed route or nature interpretation where specified","Roam Ceylon access and timing coordination","A low-impact pace suited to the setting"],know:["Trail and habitat conditions change with rainfall and season.","Follow local guidance and leave natural features undisturbed."],tips:["Wear closed shoes and carry drinking water.","Keep insect repellent and a light rain layer close at hand."],badges:[]},
  Beach:{lens:"an unhurried coastal interlude",included:["Roam Ceylon timing and location coordination","Reserved services only where specified in the proposal","Local support appropriate to the confirmed arrangement"],know:["Sea conditions and beach access vary by season and daily weather.","Lifeguard cover and swimming safety differ between beaches."],tips:["Check local advice before entering the sea.","Use reef-safe sun protection and avoid leaving valuables unattended."],badges:[]},
  Food:{lens:"Sri Lanka's regional food culture",included:["Selected tastings or meal arrangements stated in the proposal","Local host or guide where specified","Dietary-note coordination by Roam Ceylon"],know:["Menus, market produce and opening hours change with availability.","Allergies and dietary requirements must be shared before confirmation."],tips:["Arrive hungry, but let your host pace the tasting.","Carry water and ask before photographing vendors or kitchens."],badges:["Culinary Experience"]},
  Wellness:{lens:"restorative Sri Lankan wellness traditions",included:["Pre-arranged consultation or treatment stated in the proposal","Qualified practitioner or retreat team as confirmed","Roam Ceylon scheduling and transfer coordination"],know:["Wellness experiences are not a substitute for medical diagnosis or treatment.","Pregnancy, allergies, medication and health conditions must be disclosed to the practitioner."],tips:["Keep the hours after treatment lightly scheduled.","Ask what clothing, meals or preparation the practitioner recommends."],badges:["Wellness"]}
};
...
const badgesFor=(experience,category)=>{
  ...
  if(experience.priority==="Must Do")badges.push("Signature Experience","Roam Ceylon Recommended");
...
const enriched=experiences.filter(item=>!showcase.has(item.id)).map((experience,index)=>{
  ...
  const closingOptions=[
    "Roam Ceylon confirms the operating details with the selected local partner, so inclusions, access and any condition-dependent changes are clear before travel.",
  ...
  return {
    ...
    imageSource:"Pexels / existing Roam Ceylon catalogue — manual attribution review required"
  };
});
...
set name=source.name,category=source.category,short_description=source."shortDescription",full_description=source."fullDescription",
    ...
    seo_title=source.name || ' | Roam Ceylon',seo_description=source."shortDescription",updated_at=now()
